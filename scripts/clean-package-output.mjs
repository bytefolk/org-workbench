...
export const CLEAN_RELATIVE_PATHS = Object.freeze([
  ...
  "release/dist",
  // Generated by scripts/bundle-updater.mjs rather than committed, so a stale
  // bundle can never ship: it is rebuilt from the pinned dependency on every
  // package command.
  "apps/desktop/src/vendor",
