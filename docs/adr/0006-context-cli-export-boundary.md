...
The initial provider pin is `bytefolk/context@f63f57f7b4cb7071309561f0383683017ae79eb2` (context #1 R3). Workbench derives scope and occurrence identity from its durable workspace/session/turn records. It never accepts Context scope or authority from renderer input.
